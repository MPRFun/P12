...
ResolutionScaling := 1920/WindowWidth
...
tooltip, Config was made by krestmf for fucking trident hasty, %TooltipX%, %Tooltip1%, 1
tooltip, Made By AsphaltCake, %TooltipX%, %Tooltip2%, 2
tooltip, Runtime: 0h 0m 0s, %TooltipX%, %Tooltip3%, 3

tooltip, Press "P" to Start, %TooltipX%, %Tooltip5%, 5
tooltip, Press "O" to Reload, %TooltipX%, %Tooltip6%, 6
tooltip, Press "M" to Exit, %TooltipX%, %Tooltip7%, 7
